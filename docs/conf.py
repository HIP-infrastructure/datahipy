...
from bids_tools.info import __release_date__
...
sys.path.insert(0, os.path.abspath("../bids_tools"))
...
project = "bids_tools: Tools to manage BIDS datasets in the Human intracranial EEG platform"
...
.. |vrelease| replace:: {}
""".format(
    f"bids_tools=={release}", f"v{release}"
)
...
html_short_title = "HIP-BIDS Tools"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
# html_logo = "images/bids_tools-logo.png"
...
htmlhelp_basename = "BIDSToolsdoc"
...
# the title page.
# latex_logo = "images/bids_tools-logo.png"
