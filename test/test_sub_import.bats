...
@test 'assert_dir_not_exists()' {
    ...
    assert_dir_not_exists  ${PROJET_TMP_FOLDER}/${DATASET_NAME}/sub-carole
}
...
@test 'assert_db_files_exists()' {
    assert_dir_exists  ${PROJET_TMP_FOLDER}/${DATASET_NAME}/sub-carole
...
@test 'assert_file_contains()' {
    assert_file_contains  ${PROJET_TMP_FOLDER}/${DATASET_NAME}/participants.tsv 'sub-carole'
}

@test 'assert_file_owner()' {
    assert_file_owner ${USER} ${PROJET_TMP_FOLDER}/${DATASET_NAME}
    # assert_file_owner ${USER} ${PROJET_TMP_FOLDER}/${DATASET_NAME}/sub-carole
